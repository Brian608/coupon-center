package org.feather.coupon.template.service;
...
import org.feather.coupon.template.convert.CouponTemplateConverter;
import org.feather.coupon.template.dao.CouponTemplateDao;
import org.feather.coupon.template.dao.entity.CouponTemplate;
import org.feather.coupon.template.service.intf.CouponTemplateService;
...
public class CouponTemplateServiceImpl  implements CouponTemplateService {
    ...
    public List<CouponTemplateInfo> searchTemplate(CouponTemplateInfo request) {
        org.feather.coupon.template.dao.entity.CouponTemplate example = org.feather.coupon.template.dao.entity.CouponTemplate.builder()
                .shopId(request.getShopId())
                .category(CouponType.convert(request.getType()))
                .available(request.getAvailable())
                .name(request.getName())
...
//        templateDao.findAll(Example.of(example), page);
        List<org.feather.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
    ...
    public Map<Long, CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids) {
        ...
        List<org.feather.coupon.template.dao.entity.CouponTemplate> templates = templateDao.findAllById(ids);
